...
public class MovePortraitCam : MonoBehaviour
{
    ...
    private float FindMoveReductionFactor()
    {
        ...
        {
            case 0:
                MRF = 0.0025f + (-0.001f * (cameraToMove.transform.position.z - minZ) / 6.74f);
                break;
            case 1:
                MRF = 0.03f + (-0.015f * (cameraToMove.transform.position.z - minZ) / 93f);
                break;
            case 2:
                MRF = 0.009f + (-0.0065f * (cameraToMove.transform.position.z - minZ) / 14f);
                break;
            default:
                MRF = 0;
                break;
